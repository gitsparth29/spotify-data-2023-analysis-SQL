...
7. Compare the most popular song keys with song keys most represented in the top 50 tracks of 2023.

8. Calculate the average popularity for the artists in the Spotify data table. Then, for every artist with an average popularity of 90 or above, show their name, their average popularity, and label them as a “Top Artist."